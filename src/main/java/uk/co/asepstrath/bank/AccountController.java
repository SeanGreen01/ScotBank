...
public class AccountController extends Jooby {
    ...
    public String getLoginPage(Context ctx) throws IOException {
        ...
        String html = template.apply(Map.of("demoMode", App.isDemoMode()));
    ...
    double calculateCurrentAmountFromTransactions(String username) {
        return calculateCurrentAmount(getStartingAmountFromUUID(username),
                getAllTransactionsInvolvingAccount(username), username);
    }
