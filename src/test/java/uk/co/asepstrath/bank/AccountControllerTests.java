...
public class AccountControllerTests {
    ...
    void testFindTransactionById_ValidId() {
        ...
        transactions.add(new Transactions("123456", 100.0, "sender1", "transaction1", "receiver1", "PAYMENT"));
        transactions.add(new Transactions("789012", 200.0, "sender2", "transaction2", "receiver2", "WITHDRAWAL"));
    ...
    void testCalculateCurrentAmountFromTransactions() {
        ...
        userTransactions.add(new Transactions("123456", 50.0, "sampleUser", "transaction1", "receiver1", "PAYMENT"));
        userTransactions.add(new Transactions("789012", 25.0, "sampleUser", "transaction2", "receiver2", "WITHDRAWAL"));
        ...
        Mockito.doReturn(userTransactions).when(mockController).getAllTransactionsInvolvingAccount(username);
    ...
    void testGetOutgoingTransactions() {
        ...
        List<Transactions> transactions = new ArrayList<>();
        transactions.add(new Transactions("1", 100.0, "sender1", "transaction1", "receiver1", "PAYMENT"));
        transactions.add(new Transactions("2", 200.0, "sender2", "transaction2", "receiver2", "WITHDRAWAL"));
    ...
    void testCalculateSpendingSummary() throws SQLException {
        ...
        when(resultSet.getDouble("totalAmount")).thenReturn(5000.0).thenReturn(7500.0); // Mock total amount values
        when(preparedStatement.executeQuery()).thenReturn(resultSet);
